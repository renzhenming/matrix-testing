...
Java_com_rzm_matrix_1testing_hooks_JNIObj_doMmap(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_rzm_matrix_1testing_hooks_JNIObj_reallocTest(JNIEnv *env, jobject instance) {
    void *p = malloc(1024);
    p = realloc(p, 2048);
    // leak p
...
JNIEXPORT void JNICALL
Java_com_rzm_matrix_1testing_hooks_JNIObj_mallocTest(JNIEnv *env, jclass clazz) {
//    malloc_test();
#define LEN 20
...
JNIEXPORT void JNICALL
Java_com_rzm_matrix_1testing_hooks_JNIObj_threadTest(JNIEnv *env, jclass clazz) {
